...
redis:set(angel.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(angel..'lock:join:'..msg.chat_id_,true)
...
redis:del(angel..'lock:join:'..msg.chat_id_)
return "*•~** أهلا عزيزي *"..msg.TheRankCmd.."*\n•~** تم فتح الدخول بالرابط \n✓*" 
end


local function iangel(msg,MsgText)

Channel = redis:get(angel..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(angel..'joinchnl') then
...
redis:setex(angel..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(angel..'CheckExpire::'..msg.chat_id_) then 
redis:set(angel..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'•~تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... •~')
sendMsg(SUDO_ID,0,'•~تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... •~\n•~ في مجموعه  » »  '..redis:get(angel..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "•~**هذا الامر يخص {المطور} فقط  \n❗️" end
if MsgText[2] == '1' then
redis:setex(angel..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(angel..'CheckExpire::'..msg.chat_id_) then 
redis:set(angel..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'•~تم تفعيل الاشتراك   •~\n•~الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'•~تم تفعيل الاشتراك  •~ \n•~الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(angel..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(angel..'CheckExpire::'..msg.chat_id_) then 
redis:set(angel..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(angel..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(angel..'CheckExpire::'..msg.chat_id_) then 
redis:set(angel..'CheckExpire::'..msg.chat_id_,true) end
...
if not msg.Admin then return "•~**هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❗️" end
local check_time = redis:ttl(angel..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(angel..'group:name'..msg.chat_id_) or '')
redis:set(angel..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
users = redis:get(angel..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if not msg.Director then return "•~**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❗️" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. angel..'')
...
if not msg.Director and redis:get(angel..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(angel..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Admin then return "•~**هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❗️" end
if not MsgText[2] and msg.reply_id then
if redis:get(angel..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(angel..'lock:kara:'..msg.chat_id_) == 'on' then
...
local Admins = redis:scard(angel..'admins:'..msg.chat_id_)
redis:del(angel..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(angel..'owners:'..msg.chat_id_)
redis:del(angel..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(angel..'whitelist:'..msg.chat_id_)
redis:del(angel..'whitelist:'..msg.chat_id_)
...
if not msg.Director then return "•~**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❗️" end
if not redis:get(angel..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(angel..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(angel..'ExCmdLink'..msg.chat_id_,120,true)
...
if not msg.Director then return "•~**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❗️" end
redis:setex(angel..'linkGroup'..msg.sender_user_id_,300,true)
return '•~عزيزي قم برسال الرابط الجديد ...🃏'
end

if MsgText[1] == "الرابط" then
if not redis:get(angel..'linkGroup'..msg.chat_id_) then 
return "•~** اوه لا يوجد رابط\n•~**لانشاء رابط ارسل { `انشاء رابط` }\n📡" 
end
local GroupName = redis:get(angel..'group:name'..msg.chat_id_)
local GroupLink = redis:get(angel..'linkGroup'..msg.chat_id_)
...
local Text = "•~ رابـط الـمـجـمـوعه \n•~ "..Flter_Markdown(redis:get(angel..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
if not msg.Admin then return "•~**هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❗️" end
redis:setex(angel..'rulse:witting'..msg.sender_user_id_,300,true)
return '•~حسنا عزيزي  \n•~الان ارسل القوانين  للمجموعه '
end

if MsgText[1] == "القوانين" then
if not redis:get(angel..'rulse:msg'..msg.chat_id_) then 
return "•~**مرحباً بك ، يا عزيزي .\nكن مسلاماً ، فأنت هنا لترفيه عن نفسك .\n"
else 
return "*•~ القوانين :*\n"..redis:get(angel..'rulse:msg'..msg.chat_id_) 
end 
end
...
redis:set(angel..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "•~**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❗️" end
local Mn3Word = redis:scard(angel..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "•~** عذرا لا توجد كلمات ممنوعه ليتم حذفها ✓" 
end
redis:del(angel..':Filter_Word:'..msg.chat_id_)
...
redis:del(angel..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "•~**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❗️" end
if not redis:get(angel..'welcome:msg'..msg.chat_id_) then 
return "•~** اوه هنالك خطأ\n•~ عذرا لا يوجد ترحيب ليتم مسحه ✓" 
end
redis:del(angel..'welcome:msg'..msg.chat_id_)
...
if not msg.SudoUser then return "•~**هذا الامر يخص {المطور} فقط  \n❗️" end
local NumMnsha = redis:scard(angel..':Hussain:'..msg.chat_id_)
if NumMnsha ==0 then 
return "•~عذرا لا يوجد منشى اساسي \n!" 
end
redis:del(angel..':Hussain:'..msg.chat_id_)
...
if not msg.SudoUser then return "•~**هذا الامر يخص {المطور} فقط  \n❗️" end
local NumMnsha = redis:scard(angel..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "•~عذرا لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(angel..':MONSHA_BOT:'..msg.chat_id_)
...
redis:del(angel..'banned:'..msg.chat_id_)
return "•~**أهلا عزيزي "..msg.TheRankCmd.."   \n•~ تم مسح {* "..#list.." *} من المحظورين  \n✓"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "•~**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❗️" end
local MKTOMEN = redis:scard(angel..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "•~** لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(angel..'is_silent_users:'..msg.chat_id_)
...
redis:del(angel..'linkGroup'..msg.chat_id_)
...
if not msg.Creator then return "•~**هذا الامر يخص {المطور,المنشئ} فقط  \n❗️" end
redis:setex(angel..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(angel..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "•~**هذا الامر يخص {المطور,المنشئ} فقط  \n❗️" end
redis:setex(angel..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(angel..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(angel..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(angel..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(angel..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
if redis:get(angel..'lock_id'..msg.chat_id_) then 
local msgs = redis:get(angel..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then UserNameID = "@"..data.username_.."" else UserNameID = "" end
local points = redis:get(angel..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if points and points ~= "0" then
nko = points
else
nko = '0'
end
local rfih = (redis:get(angel..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(angel..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local Namei = FlterName(data.first_name_..' '..(data.last_name_ or ""),20)
GetPhotoUser(msg.sender_user_id_,function(arg, data)
if redis:get(angel.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		...
		sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,'-User: '..UserNameID..' .\n-Msg: '..msgs..' .\n-Sta: '..msg.TheRank..' .\n-id: '..msg.sender_user_id_..' .\n\nSource Angel .',dl_cb,nil)
		else
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(angel..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(angel..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(angel..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(angel..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(angel..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(angel..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(angel..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(angel..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(angel..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:del(angel..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "•~**تم مسح {* "..msgs.." *} من رسائلك 🃏\n✓"
end

if MsgText[1]== 'جهاتي' then
return '•~**  عدد جهآتك آلمـضـآفه‏‏ ⇜ ❪ '..(redis:get(angel..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n🃏'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(angel..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "•~**عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(angel..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
local points = redis:get(angel..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
if points == 0 then  return "•~**عذرا ليس لديك نقاط لكي يتم مسحها" end
redis:del(angel..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(angel..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(angel..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(angel..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(angel..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(angel..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(angel..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(angel..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(angel..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(angel..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "•~**هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❗️" end
redis:set(angel..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "•~**هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❗️" end
if redis:get(angel..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(angel..'welcome:msg'..msg.chat_id_))
else 
return "•~**أهلا عزيزي "..msg.TheRankCmd.."  \n•~نورت المجموعه \n🃏" 
end 
end
...
redis:setex(angel..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(angel..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[•~اهلا انابوت اسـمـي ]]..redis:get(angel..':NameBot:')..[[ ✓
...
redis:setex(angel..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '•~حسننا عزيزي \n•~الان قم بارسال الكليشه \n' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(angel..':addnumberusers',MsgText[2]) 
return '•~** تم وضـع شـرط آلتفعيل آلبوت آذآ كآنت آلمـجمـوعه‏‏ آكثر مـن *【'..MsgText[2]..'】* عضـو  \n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'•~** شـرط آلتفعيل آلبوت آذآكآنت آلمـجمـوعهہ‏‏ آكثر مـن *【'..redis:get(angel..':addnumberusers')..'】* عضـو  \n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات " then
if not msg.SudoUser then return "•~**هذا الامر يخص {المطور} فقط  \n❗️" end
return '•~** عدد المجموعات المفعلة » `'..redis:scard(angel..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين " then
if not msg.SudoUser then return "•~**هذا الامر يخص {المطور} فقط  \n❗️" end
return '•~**عدد المشتركين في البوت : `'..redis:scard(angel..'users')..'` \n'
end
...
if not msg.SudoUser then return "•~**هذا الامر يخص {المطور} فقط  \n❗️" end
if redis:sismember(angel..'group:ids',MsgText[2]) then
local name_gp = redis:get(angel..'group:name'..MsgText[2])
...
return redis:get(angel..":TEXT_SUDO") or '•~لا توجد كليشه المطور .\n•~يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه " then
if not msg.SudoUser then return"•~**هذا الامر يخص {المطور} فقط  \n❗️" end
if not msg.SudoBase and not redis:get(angel..'lock_brod') then 
return "•~** الاذاعه مقفوله من قبل المطور الاساسي  ❗️" 
end
redis:setex(angel..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(angel..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(angel..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(angel..'fwd:groups'..msg.sender_user_id_,300, true) 
...
if not msg.Admin then return "•~**هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❗️" end
redis:del(angel..'welcom:witting'..msg.sender_user_id_,
angel..'rulse:witting'..msg.sender_user_id_,
angel..'rulse:witting'..msg.sender_user_id_,
angel..'name:witting'..msg.sender_user_id_,
angel..'about:witting'..msg.sender_user_id_,
angel..'fwd:all'..msg.sender_user_id_,
angel..'fwd:pv'..msg.sender_user_id_,
angel..'fwd:groups'..msg.sender_user_id_,
angel..'namebot:witting'..msg.sender_user_id_,
angel..'addrd_all:'..msg.sender_user_id_,
angel..'delrd:'..msg.sender_user_id_,
angel..'addrd:'..msg.sender_user_id_,
angel..'delrdall:'..msg.sender_user_id_,
angel..'text_sudo:witting'..msg.sender_user_id_,
angel..'addrd:'..msg.chat_id_..msg.sender_user_id_,
angel..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoBase then return "•~**هذا الامر يخص {المطور الاساسي} فقط  \n❗️" end
local GetVerison = https.request('https://github.com/angelTELEE/angel.github.io/GetVersion.txt') or 0
if GetVerison > version then
UpdateSourceStart = true
sendMsg(msg.chat_id_,msg.id_,'➿** يوجد تحديث جديد الان \n🃏** جاري تنزيل وتثبيت التحديث  ...')
redis:set(angel..":VERSION",GetVerison)
return false
else
...
sendMsg(msg.chat_id_,msg.id_,'•~** عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع انجيل  انجل يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n❗️')
end  
else
...
if not msg.SudoBase then return"•~**هذا الامر يخص {المطور الاساسي} فقط  \n❗️" end
return '•~الاحصائيات 🃏 \n\n•~**عدد المجموعات المفعله : '..redis:scard(angel..'group:ids')..'\n•~**عدد المشتركين في البوت : '..redis:scard(angel..'users')..'\n'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام " then
if not msg.SudoBase then return"•~**هذا الامر يخص {المطور الاساسي} فقط  \n❗️" end
redis:setex(angel..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(angel..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
return "•~حسننا الان ارسل كلمة الرد العام ➿\n"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود' then
if not msg.Director then return "•~**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❗️" end
local names 	= redis:exists(angel..'replay:'..msg.chat_id_)
local photo 	= redis:exists(angel..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(angel..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(angel..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(angel..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(angel..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(angel..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(angel..'replay:'..msg.chat_id_,angel..'replay_photo:group:'..msg.chat_id_,angel..'replay_voice:group:'..msg.chat_id_,
angel..'replay_animation:group:'..msg.chat_id_,angel..'replay_audio:group:'..msg.chat_id_,angel..'replay_sticker:group:'..msg.chat_id_,angel..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(angel..'replay:all')
local photo 	= redis:exists(angel..'replay_photo:group:')
local voice 	= redis:exists(angel..'replay_voice:group:')
local imation 	= redis:exists(angel..'replay_animation:group:')
local audio 	= redis:exists(angel..'replay_audio:group:')
local sticker 	= redis:exists(angel..'replay_sticker:group:')
local video 	= redis:exists(angel..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(angel..'replay:all',angel..'replay_photo:group:',angel..'replay_voice:group:',angel..'replay_animation:group:',angel..'replay_audio:group:',angel..'replay_sticker:group:',angel..'replay_video:group:')
...
if not msg.SudoBase then return"•~**هذا الامر يخص {المطور الاساسي} فقط  \n❗️" end
redis:set(angel..'delrdall:'..msg.sender_user_id_,true) 
return "•~حسننا عزيزي  \n•~الان ارسل الرد لمسحها من  المجموعات "
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "•~**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❗️" end
redis:set(angel..'delrd:'..msg.sender_user_id_,true)
return "•~حسننا عزيزي  \n•~الان ارسل الرد لمسحها من  للمجموعه "
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "•~**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❗️" end
local names  	= redis:hkeys(angel..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(angel..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(angel..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(angel..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(angel..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(angel..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(angel..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(angel..'replay:all')
local photo 	= redis:hkeys(angel..'replay_photo:group:')
local voice 	= redis:hkeys(angel..'replay_voice:group:')
local imation 	= redis:hkeys(angel..'replay_animation:group:')
local audio 	= redis:hkeys(angel..'replay_audio:group:')
local sticker 	= redis:hkeys(angel..'replay_sticker:group:')
local video 	= redis:hkeys(angel..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '•~**لا يوجد ردود مضافه حاليا \n❗️' 
end
local ii = 1
...
if not msg.Director then return "•~**هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❗️" end
redis:setex(angel..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(angel..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "•~حسننا , الان ارسل كلمه الرد \n-"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"•~**هذا الامر يخص {المطور الاساسي} فقط  \n❗️" end
redis:setex(angel..'namebot:witting'..msg.sender_user_id_,300,true)
...
6- الالعاب > لعرض العاب البوت

7- نقاطي > لمعرفه عدد نقاطك

8- بيع نقاطي + العدد > لبيع نقاطك لتحصل على رسائل

9- معلوماتي > لعرض معلوماتك

10- السورس > لعرض سورس البوت

11- الرتبه بالرد > لمعرفه رتبه الشخص

12- التفاعل بالمعرف > لمعرفه تفاعل الشخص

13- التفاعل بالــرد > لمعرفه تفاعل الشخص

14- كشف بالمعرف > لمعرفه معلومات حسابه

15- كشف بالرد > لمعرفه معلومات حسابه

16- كشف البوتات > لاظهار عدد
 البوتات الموجوده بالمجموعه

17- طرد البوتات > لطرد كل البوتات

18- طرد المحذوفين > لطرد الحسابات المحذوفه

19- رابط الحذف > لحذف حسابك
...
3- تفعيل > تعطيل  الالعـاب

4- تفعيل > تعطيل   التحذير 

5- تفعيل > تعطيل   الترحيب 

6- تفعيل > تعطيل   الايدي

7- تفعيل > تعطيل   الايدي بالصوره
...
if not msg.Admin then return "•~**هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❗️" end
if not redis:get(angel..'lave_me'..msg.chat_id_) then 
return "•~**أهلا عزيزي "..msg.TheRankCmd.."\n•~** المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(angel..'lave_me'..msg.chat_id_) 
return "•~**أهلا عزيزي "..msg.TheRankCmd.."\n•~** تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "•~**هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❗️" end
if redis:get(angel..'lave_me'..msg.chat_id_) then 
return "•~**أهلا عزيزي "..msg.TheRankCmd.."\n•~** المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(angel..'lave_me'..msg.chat_id_,true)  
...
if not msg.SudoBase then return"•~**هذا الامر يخص {المطور الاساسي} فقط  \n❗️" end
local SubDel = redis:del(angel..":UserNameChaneel")
if SubDel == 1 then
...
if redis:get(angel..'welc'..msg.chat_id_) == 'on' then
if msg.content_.ID == 'MessageChatJoinByLink' then
function WelcomeByAddUser(BlaCk,Diamond)
local function setlinkgp(td,mrr619)
function gps(arg,data)

txt = 'اهلاً بك يا عزيزي . '..(data.title_ or '---')..' \n..\n'..mrr619.member_count_..'\n '..mrr619.administrator_count_..' \n
【*'..os.date("%H:%M:%S")..'*】\n 【*'..os.date("%Y/%m/%d")..'*】\n'
...
local hash = angel..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
------set cmd------
Black = msg.text 
mmd = redis:get(angel..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(angel..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(angel..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'•~اهلا عزيزي \n•~تم تثبيت الامر الجديد\n✓')
redis:del(angel..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end

if Black:match('تغير امر (.*)') then
if not msg.Kara then return "•~**هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n❗️" end
local cmd = Black:match('تغير امر (.*)') 
redis:setex(angel..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
...
redis:hdel(angel..'CmD:'..msg.chat_id_,cmd)
redis:srem(angel..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"•~اهلا عزيزي\nالامر >"..cmd.."\n•~ تم مسحه من قائمه الاوامر\n✓")
end
if Black == 'مسح قائمه الاوامر' or Black == 'مسح قائمه الاوامر' then
if not msg.Kara then return "•~**هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n❗️" end
redis:del(angel..'CmD:'..msg.chat_id_)
redis:del(angel..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"•~ اهلا عزيزي تم مسح قائمه الاوامر")
end
if Black == "قائمه الاوامر" then
if not msg.Kara then return "•~**هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n❗️" end
local CmDlist = redis:smembers(angel..'CmDlist:'..msg.chat_id_)
local t = '•~ قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(angel..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
redis:set(angel..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(angel..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(angel..'welc'..msg.chat_id_,'off')
redis:del(angel..'welc'..msg.chat_id_,'on')
else
...
function tophoto(kara,angel)   
if angel.content_.ID == "MessageSticker" then        
local bd = angel.content_.sticker_.sticker_.path_          
...
local msg_pv = tonumber(redis:get(angel..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(angel..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*•~* تم حظرك من البوت بسبب التكرار \n❗️') 
end
redis:setex(angel..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end
...
redis:sadd(angel..'users',msg.sender_user_id_)
if redis:get(angel..'lock_service') then 
text = [[•~اهلاً انا بـوت اسـمي []]..redis:get(angel..':NameBot:')..[[]🃏
...
text = [[•~ اهلاً انابـوت اسمي []]..redis:get(angel..':NameBot:')..[[]🃏
•~لحماية المجموعات من البوتات
والتوجيه‌‏ والتكرار وغيره...
...
local MSG_ID = (redis:get(angel.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
if not redis:get(angel..'lock_twasel') then
...
redis:setex(angel.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
sendMsg(msg.chat_id_,msg.id_,"•~تم ارسال رسـالتك الى المطور\n•~سـار عليك في اقرب وقت\n•🃏معرف المطور "..SUDO_USER)
...
--====================== Reply Only Group ====================================
if redis:get(angel..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(angel..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(angel..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(angel..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(angel..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ✓ تم اضافت الرد 🃏 \n-')
elseif msg.photo then 
redis:hset(angel..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(angel..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'•➿تم اضافه صوره للرد بنجاح ✓\n•➿يمكنك ارسال ❴ ['..klma..'] ❵ لاظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(angel..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(angel..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'•➿تم اضافه بصمه صوت للرد بنجاح ✓\n•➿يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(angel..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(angel..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'•➿تم اضافه متحركه للرد بنجاح ✓\n•➿يمكنك ارسال ❴ ['..klma..'] ❵ لاظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(angel..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(angel..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'•➿تم اضافه فيديو للرد بنجاح ✓\n•➿يمكنك ارسال ❴ ['..klma..'] ❵ لاظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(angel..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(angel..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'•➿تم اضافه للصوت للرد بنجاح ✓\n•➿يمكنك ارسال ❴ ['..klma..'] ❵ لاظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(angel..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(angel..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(angel..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(angel..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(angel..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(angel..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(angel..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ✓ تم اضافت الرد لكل المجموعات 🃏 ')
elseif msg.photo then 
redis:hset(angel..'replay_photo:group:',klma,photo_id)
redis:del(angel..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'•➿تم اضافه صوره للرد العام ✓\n•➿يمكنك ارسال ❴ ['..klma..'] ❵ لاظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(angel..'replay_voice:group:',klma,voice_id)
redis:del(angel..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'•➿تم اضافه بصمه صوت للرد العام ✓\n•➿يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(angel..'replay_animation:group:',klma,animation_id)
redis:del(angel..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'•➿تم اضافه متحركه للرد العام ✓\n•➿يمكنك ارسال ❴ ['..klma..'] ❵ لاظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(angel..'replay_video:group:',klma,video_id)
redis:del(angel..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'•➿تم اضافه فيديو للرد العام ✓\n•➿يمكنك ارسال ❴ ['..klma..'] ❵لاظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(angel..'replay_audio:group:',klma,audio_id)
redis:del(angel..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'•➿تم اضافه للصوت للرد العام ✓\n•➿يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(angel..'replay_sticker:group:',klma,sticker_id)
redis:del(angel..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(angel..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(angel..":ForceSub:"..msg.sender_user_id_)
...
redis:set(angel..":UserNameChaneel",msg.text)
...
if redis:get(angel..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(angel..'namebot:witting'..msg.sender_user_id_)
redis:set(angel..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"•~تم تغير اسم البوت ➿\n•~الان اسمه "..Flter_Markdown(msg.text).." \n✓")
return false
end

if redis:get(angel..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(angel..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(angel..'replay_photo:group:',msg.text)
redis:hdel(angel..'replay_voice:group:',msg.text)
redis:hdel(angel..'replay_animation:group:',msg.text)
redis:hdel(angel..'replay_audio:group:',msg.text)
redis:hdel(angel..'replay_sticker:group:',msg.text)
redis:hdel(angel..'replay_video:group:',msg.text)
redis:setex(angel..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"•➰جيد , يمكنك الان ارسال جوا ب الردالعام \n•➰[[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n✓")
end
end

if redis:get(angel..'delrdall:'..msg.sender_user_id_) then
redis:del(angel..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(angel..'replay:all',msg.text)
local photo =redis:hget(angel..'replay_photo:group:',msg.text)
local voice = redis:hget(angel..'replay_voice:group:',msg.text)
local animation = redis:hget(angel..'replay_animation:group:',msg.text)
local audio = redis:hget(angel..'replay_audio:group:',msg.text)
local sticker = redis:hget(angel..'replay_sticker:group:',msg.text)
local video = redis:hget(angel..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'•~**هذا الرد ليس مضاف في قائمه الردود ❗️')
else
redis:hdel(angel..'replay:all',msg.text)
redis:hdel(angel..'replay_photo:group:',msg.text)
redis:hdel(angel..'replay_voice:group:',msg.text)
redis:hdel(angel..'replay_audio:group:',msg.text)
redis:hdel(angel..'replay_animation:group:',msg.text)
...
if redis:get(angel..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(angel..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(angel..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "•➰** تم وضع الكليشه بنجاح كلاتي 🃏\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n✓")
end
if redis:get(angel..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(angel..'welcom:witting'..msg.sender_user_id_) 
redis:set(angel..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"•~** تم وضع الترحيب بنجاح كلاتي ➰\n✓" )
end
if redis:get(angel..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(angel..'rulse:witting'..msg.sender_user_id_) 
redis:set(angel..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'•~** مرحبآ عزيزي\n•~تم حفظ القوانين بنجاح ✓\n•~ارسل [[ القوانين ]] لعرضها \n✓')
end
if redis:get(angel..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(angel..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(angel..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(angel..'linkGroup'..msg.sender_user_id_,link) 
redis:set(angel..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'•~تم وضع الرابط الجديد بنجاح .. ➰')
end
if redis:get(angel..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(angel..'about:witting'..msg.sender_user_id_) 
...
if redis:get(angel..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(angel..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(angel..'users')  
local groups = redis:smembers(angel..'group:ids')
...
if redis:get(angel..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(angel..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(angel..'users')
if #pv >= 300 then
...
if redis:get(angel..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(angel..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(angel..'group:ids')
if #groups >= 300 then
...
if msg.adduser and msg.adduser == our_id and redis:get(angel..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(angel..':WELCOME_BOT'),[[•~اهلا انآ بوت آسـمـي ]]..redis:get(angel..':NameBot:')..[[ ✓
...
if msg.forward_info and redis:get(angel..'fwd:'..msg.sender_user_id_) then
redis:del(angel..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(angel..'users')
local groups = redis:smembers(angel..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(angel..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(angel..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(angel..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'•~تم تغيير صـورة آلترحيب للبوت ➰\n✓')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(angel..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(angel..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(angel..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(angel..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(angel..'replay:'..msg.chat_id_,msg.text)
redis:hdel(angel..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(angel..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(angel..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(angel..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(angel..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(angel..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(angel..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"•➿جيد , يمكنك الان ارسال جواب الرد \n•➿[[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n✓")
end
end

if redis:get(angel..'delrd:'..msg.sender_user_id_) then
redis:del(angel..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(angel..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(angel..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(angel..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(angel..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(angel..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(angel..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(angel..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(angel..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(angel..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(angel..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
if redis:get(angel..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(angel..'welcome:msg'..msg.chat_id_) or "•~ اهلاً بك عزيزي {الاسم}\n•~ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين \nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n•~اسم المجموعه » {المجموعه}")
if welcome then
rules = (redis:get(angel..'rulse:msg'..msg.chat_id_) or "•~ كن مسلام .\n•~ممنوع نشر الروابط\n•~ ممنوع التوجيه وشكراً .\n•~ممنوع التكرار وشكراً .\n•~ممنوع الإسائه للأخرين\n•~فأنت هنا تمثل شخصيتك بأفعالك .\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(angel..'group:name'..msg.chat_id_) or '')))
...
welcome = (redis:get(angel..'welcome:msg'..msg.chat_id_) or "•~اهلن بك عزيزي {الاسم}\n•~معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين \nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n•~اسم المجموعه» {المجموعه}")
if welcome then
rules = (redis:get(angel..'rulse:msg'..msg.chat_id_) or "•~كن مسلام .\n•~ممنوع نشر الروابط وشكراً .\n•~ممنوع التوجيه وشكراً .\n•~ممنوع التكرار وشكراً .\n•~ممنوع الإسائه للأخرين .\n•~فأنت هنا تمثل شخصيتك بأفعالك .\n")
welcome = welcome:gsub("{القوانين}", rules)
...
--------------------------------------------
if msg.adduser and redis:get(angel..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(angel..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(angel..'welcome:get'..msg.chat_id_)
end
redis:setex(angel..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(angel..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(angel..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_angel = (redis:get(angel..'num_msg_angel'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_angel) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(angel..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"🙍🏻‍♂╿العضو » "..USERNAME.."\n🚸╽قمـت بتگرآر آگثر مـن "..NUM_MSG_angel.." رسـآلهہ‌‏ , لذآ تم تقييدگ مـن آلمـجمـوعهہ‌‏ ✓\n",12,USERCAR) 
return false
end)
end 
redis:setex(angel..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
if redis:get(angel..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(angel..'lock_woring'..msg.chat_id_) and not redis:get(angel..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(angel..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(angel..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(angel..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send inline \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'📛*╿* لا يمكنني مسح الرساله المخالفه .\n🎟*╽* لست مشرف او ليس لدي صلاحيه  الحذف \n 💥')    
end
if redis:get(angel..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(angel..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(angel..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(angel..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(angel..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(angel..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(angel..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(angel..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(angel..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(angel..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(angel..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(angel..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(angel..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(angel..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(angel..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(angel..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(angel..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(angel..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(angel..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(angel..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(angel..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(angel..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(angel..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(angel..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(angel..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(angel..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(angel..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(angel..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(angel..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(angel..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(angel..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(angel..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(angel..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(angel..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(angel..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(angel..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(angel..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(angel..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(angel..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(angel..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(angel..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(angel..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
return sendMsg(msg.chat_id_,msg.id_,"•~ ما اقدر اكول اكثر من 500 حرف ")
end
...
if redis:get(angel..'CheckExpire::'..msg.chat_id_) then
local ExpireDate = redis:ttl(angel..'ExpireDate:'..msg.chat_id_)
if not ExpireDate and not msg.SudoUser then
rem_data_group(msg.chat_id_)
sendMsg(SUDO_ID,0,'🕵🏼️‍♀️╿انتهى الاشتراك في احد المجموعات ✋🏿\n👨🏾‍🔧│المجموعه : '..FlterName(redis:get(angel..'group:name'..msg.chat_id_))..'🍃\n💂🏻‍♀️╽ايدي : '..msg.chat_id_)
sendMsg(msg.chat_id_,0,'🕵🏼️‍♀️╿انتهى الاشتراك البوت✋🏿\n💂🏻‍♀️│سوف اغادر المجموعه فرصه سعيده 👋🏿\n👨🏾‍🔧╽او راسل المطور للتجديد '..SUDO_USER..' 🍃')
return StatusLeft(msg.chat_id_,our_id)
else
local DaysEx = (redis:ttl(angel..'ExpireDate:'..msg.chat_id_) / 86400)
